...
int main(void)
{
  ...
  /* USER CODE BEGIN 1 */
	...
	// HCSR04 code to send out a pulse
	...
	// end of pulse sending for distance sensor
  ...
  while (1)
  {
	  ...
	  // time_diff = Pulse Width and distance is the distance
    ...
    /* USER CODE END WHILE */
	  ...
	  sprintf((char*)txd_message_buffer, "Digitized value: %d \r\n", ADC_CH9);
