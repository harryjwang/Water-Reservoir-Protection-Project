...
#define DIGIT_A3_Pin GPIO_PIN_0
#define DIGIT_A3_GPIO_Port GPIOA
#define DIGIT_A2_Pin GPIO_PIN_1
#define DIGIT_A2_GPIO_Port GPIOA
#define USART_TX_Pin GPIO_PIN_2
#define USART_TX_GPIO_Port GPIOA
#define USART_RX_Pin GPIO_PIN_3
#define USART_RX_GPIO_Port GPIOA
#define DIGIT_A1_Pin GPIO_PIN_4
#define DIGIT_A1_GPIO_Port GPIOA
#define LD2_Pin GPIO_PIN_5
#define LD2_GPIO_Port GPIOA
#define DIGIT_A0_Pin GPIO_PIN_0
...
#define DIGIT_B1_Pin GPIO_PIN_14
#define DIGIT_B1_GPIO_Port GPIOB
#define BLUE_Pin GPIO_PIN_15
#define BLUE_GPIO_Port GPIOB
#define DIGIT_B2_Pin GPIO_PIN_10
#define DIGIT_B2_GPIO_Port GPIOA
